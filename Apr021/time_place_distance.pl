...
sub info{
            ...
            print "Time of arrival from Bangalore to $place:$address->[0]\n";
              print "Distance from Bangalore to $place:$address->[1]\n";
               ...
               my $hour=$hour_min[0];
               my $min=$hour_min[1];
               print "Duration of journey from bangalore to $place:$hour hour and $min min\n";
...
"Duration of journey between $district1 and $district is:$hour hour and $min min\n";
    ...
    if ( $distance1 >= $distance2 ) {
        ...
        print "Distance between $district and $district1:$distance km \n";
    }
    else {

        $distance = $distance2 - $distance1;
        print "Distance between $district1 and $district:$distance km \n";
